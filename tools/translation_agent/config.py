...
GITHUB_CLONE_PATH_ASPOSE_COM    = os.getenv("GITHUB_CLONE_PATH_ASPOSE_COM", "")
GITHUB_CLONE_PATH_GROUPDOCS_COM = os.getenv("GITHUB_CLONE_PATH_GROUPDOCS_COM", "")
GITHUB_CLONE_PATH_CONHOLDATE_COM= os.getenv("GITHUB_CLONE_PATH_CONHOLDATE_COM", "")
GITHUB_CLONE_PATH_ASPOSE_CLOUD  = os.getenv("GITHUB_CLONE_PATH_ASPOSE_CLOUD", "")
GITHUB_CLONE_PATH_GROUPDOCS_CLOUD=os.getenv("GITHUB_CLONE_PATH_GROUPDOCS_CLOUD", "")
GITHUB_CLONE_PATH_CONHOLDATE_CLOUD=os.getenv("GITHUB_CLONE_PATH_CONHOLDATE_CLOUD", "")
